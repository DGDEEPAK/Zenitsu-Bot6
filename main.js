...
require('./Zenitsu6.js')
nocache('../Zenitsu6.js', module => console.log(color('[ CHANGE ]', 'green'), color(`'${module}'`, 'green'), 'Updated'))
require('./main.js')
nocache('../main.js', module => console.log(color('[ CHANGE ]', 'green'), color(`'${module}'`, 'green'), 'Updated'))

//------------------------------------------------------
let phoneNumber = "918348225320"
...
ppgroup = 'https://i.ibb.co/RBx5SQC/avatar-group-large-v2.png?q=60'
    ...
    DeepakBotInc.ev.on('messages.upsert', async chatUpdate => {
        ...
        try {
            ...
            require("./Zenitsu6")(DeepakBotInc, m, chatUpdate, store)
        } catch (err) {
            console.log(err)
        }
    })
